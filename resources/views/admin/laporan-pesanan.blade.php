    ...
    <div class="container py-5 mt-2 animate__animated animate__fadeIn">
        ...
        <div class="page-header-elegant d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h2 class="fw-bold mb-0 text-dark" style="border-left: 5px solid #000; padding-left: 15px;">Laporan
                        Pesanan</h2>
                    ...
                    <div class="row align-items-end g-3">
                        <div class="col-md-8">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0 text-gold"><i
                ...
                <table class="table table-elegant mb-0 text-center">
                    <thead>
                        <tr>
                            ...
                            <th class="py-3 bg-danger bg-opacity-10 text-dark">Ditolak</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td><span class="stat-number text-danger text-opacity-50">{{ $stats['ditolak'] }}</span></td>
                        </tr>
                    </tbody>
                </table>
            </div>
