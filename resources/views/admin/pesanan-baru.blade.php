...
<style>
    ...
    .marble-icon-box:hover { transform: scale(1.05); background: rgba(197, 164, 126, 0.3); }
    ...
    .breadcrumb-item a { color: var(--adira-gold); text-decoration: none; font-weight: 600; }
</style>
...
<div class="container py-5 mt-2 animate__animated animate__fadeIn">
    ...
    <div class="page-header-elegant d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h2 class="fw-bold mb-0 text-dark" style="border-left: 5px solid #000; padding-left: 15px;">Pesanan Baru</h2>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-muted small">
                            <i class="far fa-calendar-alt me-1 text-gold"></i> {{ $item->created_at->format('d M Y') }}
                        </td>
                        <td>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 25px; overflow: hidden;">
            <div class="modal-header bg-dark text-white p-4">
                <h5 class="modal-title fw-bold"><i class="fas fa-file-signature me-2 text-gold"></i> Verifikasi Pesanan Baru</h5>
                ...
                <div class="modal-body p-4 bg-white text-dark">
                    <div class="row g-4">
                        <div class="col-md-7 border-end pe-md-4">
                            <label class="text-muted small fw-bold text-uppercase d-block mb-3">Rincian Permintaan</label>
                            ...
                            <div class="info-box-custom mb-3">
                                ...
                                <p class="small text-muted mb-0">Ukuran: <span id="md-ukuran" class="fw-bold"></span> | Jml: <span id="md-jumlah" class="fw-bold"></span></p>
                            </div>

                            <div class="mb-3">
                                <label class="text-muted small fw-bold text-uppercase d-block mb-1">Catatan Pembeli</label>
                                <p id="md-catatan" class="p-2 border rounded bg-light small fst-italic mb-0"></p>
                            </div>

                            <div id="md-alamat-section" class="alert alert-info border-0 shadow-sm py-2 mb-0" style="display:none;">
                                <i class="fas fa-truck-moving me-2"></i>
                                <small class="fw-bold">Tujuan Bus:</small> <span id="md-alamat" class="small fw-bold text-primary"></span>
                            </div>
                        </div>

                        <div class="col-md-5 ps-md-4">
                            <div class="p-3 border rounded-4 bg-light shadow-sm">
                                <h6 class="fw-bold text-dark mb-3"><i class="fas fa-calculator me-2 text-gold"></i> Penentuan Biaya</h6>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="total_harga" id="input_harga" class="form-control border-dark" placeholder="0" required min="1">
                                    </div>
                                </div>

                                <div class="mb-3" id="group-ongkir" style="display:none;">
                                    <label class="form-label small fw-bold text-danger">Titip Bus (Rp)</label>
                                    <div class="input-group">
                                        <span class="input-group-text border-danger bg-danger text-white">Rp</span>
                                        <input type="number" name="biaya_pengiriman" id="input_ongkir" class="form-control border-danger" value="0">
                                    </div>
                                </div>
                                ...
                                <button type="submit" class="btn btn-gold w-100 py-3 fw-bold shadow">
                                    <i class="fas fa-paper-plane me-2 text-white"></i> Simpan & Kirim
                                </button>
                            </div>
                        </div>
                    </div>
