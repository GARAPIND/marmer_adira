...
@section('content')
                                ...
                                <div class="col-md-6 border-end pe-md-5">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            <span
                                                class="input-group-text bg-white border-end-0 text-muted rounded-start-4"><i
                                                    class="fa-solid fa-maximize"></i></span>
                                ...
                                <div class="col-md-6 ps-md-5">
                                    ...
                                    <div class="row g-3 mb-4">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <select name="metode_pengambilan" id="metode_pengambilan"
                                                class="form-select input-aesthetic" onchange="toggleAlamat()" required>
                                    ...
                                    <div id="form_alamat" style="display: none;"
                                        ...
                                        <div class="shipping-box-highlight">
                                            <label class="label-aesthetic text-gold"><i
                                                    class="fa-solid fa-bus me-2"></i>Pilih Terminal Tujuan</label>
                                            <select name="terminal_id" id="terminal_id"
                                                class="form-select input-aesthetic border-gold"
                                                onchange="hitungOngkirBerat()">
                                                <option value="" data-tarif-per-kg="0" selected disabled>-- Pilih
                                                    Terminal --</option>
                                    ...
                                    <div class="summary-panel mt-4 animate__animated animate__fadeInUp">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span class="fw-bold text-uppercase"
                                                style="letter-spacing: 1px;">Total:</span>
    ...
    <script>
        ...
        function updateHarga() {
            ...
            const hargaSatuan = (selectedOption && selectedOption.getAttribute('data-harga')) ?
                parseInt(selectedOption.getAttribute('data-harga')) : 0;

            beratSatuanGlobal = (selectedOption && selectedOption.getAttribute('data-berat')) ?
                parseFloat(selectedOption.getAttribute('data-berat')) : 0;
            ...
            const displayBerat = document.getElementById('display_berat_satuan');

            if (beratSatuanGlobal > 0 && !selectedOption.disabled) {
                displayBerat.value = beratSatuanGlobal + ' kg';
        ...
        function hitungOngkirBerat() {
            ...
            const tarifPerKg = (selectedOption && !selectedOption.disabled) ?
                parseInt(selectedOption.getAttribute('data-tarif-per-kg')) : 0;
