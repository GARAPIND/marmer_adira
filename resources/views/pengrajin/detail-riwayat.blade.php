...
@section('content')
    ...
    <style>
        ...
        .main-title {
            ...
            font-weight: 700;
            border-bottom: 3px solid var(--adira-gold);
        ...
        <div class="card border-0 shadow-sm p-5 rounded-4 bg-white animate__animated animate__fadeIn">
            ...
            <div class="row g-5">
                <div class="col-lg-5 pe-lg-5 border-end">
                    ...
                    <div class="info-value">{{ \Carbon\Carbon::parse($pesanan->created_at)->translatedFormat('d F Y') }}
                    </div>

                    <div class="info-label">Status Akhir</div>
                    <div class="info-value">
                        <span class="badge rounded-pill px-3 py-2"
                            style="background: rgba(39, 174, 96, 0.1); color: #27ae60; border: 1px solid #27ae60;">
                            {{ $pesanan->status }}
                        </span>
                    </div>
                    ...
                    <div class="info-value">
                        <a href="https://wa.me/{{ $pesanan->user->no_telp ?? '' }}" target="_blank"
                    ...
                    {{-- MODIFIKASI: INFORMASI BIAYA ONGKOS KIRIM --}}
                    @if ($pesanan->metode_pengambilan == 'dikirim')
                        <div class="info-label">Ongkos Kirim</div>
                        <div class="info-value text-danger">Rp {{ number_format($pesanan->biaya_pengiriman, 0, ',', '.') }}
                        </div>
                        ...
                        <div class="shipping-box">
                            ...
                            <p class="mb-0 small fw-bold text-dark">
                                {{ $pesanan->alamat_pengiriman ?? 'Rincian tidak tersedia' }}</p>
                        </div>
                    @else
                    ...
                    <div class="price-tag">Rp
                        {{ number_format($pesanan->total_harga + ($pesanan->biaya_pengiriman ?? 0), 0, ',', '.') }}</div>
                </div>
                ...
                <div class="col-lg-7 ps-lg-5">
                    ...
                    <div class="info-value italic text-muted"
            ...
            <div class="mt-5 pt-4 text-center border-top">
                <a href="{{ route('pengrajin.riwayat') }}" class="btn px-5 py-2 rounded-pill shadow-sm"
                    style="border: 2px solid var(--adira-dark); color: var(--adira-dark); font-weight: 700;">
