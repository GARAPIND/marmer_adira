...
@section('content')
    <style>
        ...
        .card-stat-big {
            ...
            padding: 4rem 1rem;
            /* Ukuran kotak besar sesuai sketsa */
            text-align: center;
        ...
        .stat-value {
            font-size: 5.5rem;
            /* Angka sangat besar sesuai gambar sketsa */
            font-weight: 800;
        ...
        .border-proses {
            border-bottom-color: var(--adira-gold);
        }
    ...
    <div class="container py-5 mt-2 animate__animated animate__fadeIn">
        ...
        <div class="page-header-elegant d-flex align-items-center shadow-sm">
            ...
            <div>
                <h2 class="fw-bold mb-0 text-dark" style="border-left: 5px solid #000; padding-left: 15px;">Dashboard
                    Pengrajin</h2>
        ...
        <div class="row g-4 mt-2">
            ...
            <div class="col-md-4">
                <a href="{{ route('pengrajin.riwayat', [
                    'status' => 'Selesai',
                    'tanggal' => now()->toDateString(),
                ]) }}"
                    class="text-decoration-none">
                    <div class="card card-stat-big border-selesai">
                        <p class="stat-label">Pesanan Selesai Hari Ini</p>
